...
military = {
	...
	NAVAL_COMBAT_DAMAGE_STR_MULT = 0.15, -- scale the damage to STR for balancing gameplay
	NAVAL_COMBAT_DAMAGE_MULT_NO_ORG = 4.0, -- damage multiplier (to STR) when opponent has no ORG.
	NAVAL_COMBAT_RETREAT_CHANCE = 0.15, -- base chance for retreating when STR or ORG is low. Increased by leader experiance and speed.
	...
	NAVAL_COMBAT_RETREAT_SPEED_MOD = 0.25, -- slow down when retreating so there is a chance to hit the runner
